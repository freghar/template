...
for "_i" from 1 to 2 do {_this addItemToBackpack "tf47_m3maaws_HEAT";};
_this addItemToBackpack "tf47_m3maaws_HEDP";
...
_this addWeapon "tf47_m3maaws";
_this addSecondaryWeaponItem "tf47_optic_m3maaws";
