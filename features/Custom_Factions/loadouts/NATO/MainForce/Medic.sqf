...
_this addVest "rhsusf_iotv_ucp_Medic";
...
for "_i" from 1 to 8 do {_this addItemToBackpack "ACE_bloodIV";};
for "_i" from 1 to 16 do {_this addItemToBackpack "SmokeShell";};
for "_i" from 1 to 4 do {_this addItemToBackpack "SmokeShellGreen";};
